...
stop_words = ['thing','thee', 'that', 'it','thou','thy','which', 'thee','thou', 'shalt', 'hast', 'thereof', 'i', 'o', 'thereof', 'once','where', 'twice','third', 'fourth','fifth','sixth','seventh','eighth','nine','four','five','six','seven','eight','nine','ten','eleven','twelve', 'twenty','not','more','here','first','second','fifty','forty','one','let','thus','also','have', 'therefore','such','ever', 'surely','then','certainly','many','other','others','yet','there','too','only','who','else','much','certain','indeed','now','nothing','best','everything','despise','better','worse','hath','unto','take','say','make','come','number','him','his','her','see','know','give','take','chapter','I','IV','even', 'forth','wherefore','sake']
#NNP: 固有名詞
...
new_file = open('raw_bhagvadgita.txt', 'w')
...
# バイナリで保存
dictionary.save('bhagvadgita.dict')
# バイナリではなくテキストとして保存する
dictionary.save_as_text('bhagvadgita_readable.dict')
...
corpora.MmCorpus.serialize('bhagvadgita.mm', corpus)
